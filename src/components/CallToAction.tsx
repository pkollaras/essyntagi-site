  ...
  return (
    <section ref={ctaRef} className="py-20">
      <div className="container mx-auto px-6">
        <div 
          className={`bg-gradient-to-r from-essyntagi-600 to-essyntagi-500 rounded-3xl p-8 md:p-12 lg:p-16 relative overflow-hidden ${
        ...
        >
          ...
          <div className="relative z-10 text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-white/90 mb-8">
              Join thousands of healthcare professionals already using Essyntagi to streamline their operations and improve patient care.
            </p>
