...
const Navbar = () => {
  ...
  return (
    <header className={cn('fixed top-0 left-0 right-0 z-50 transition-all duration-300 py-4 px-6 md:px-10', 
      ...
      <div className="container mx-auto">
        <nav className="flex items-center justify-between">
          <a onClick={() => navigate('/')} className="flex items-center cursor-pointer">
            <img 
              ...
              src="/lovable-uploads/020e11ea-4772-415c-9c76-da8f956f25e4.png" 
        ...
        <div className={cn(
          'md:hidden fixed inset-x-0 transition-all duration-300 ease-in-out transform bg-white shadow-lg rounded-b-2xl z-20', 
