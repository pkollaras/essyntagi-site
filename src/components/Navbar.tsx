...
const Navbar = () => {
  ...
  return <header className={cn('fixed top-0 left-0 right-0 z-50 transition-all duration-300 py-4 px-6 md:px-10', isScrolled ? 'glass shadow-subtle py-3' : 'bg-transparent')}>
      <div className="container mx-auto">
        ...
        <div className={cn('md:hidden fixed inset-x-0 transition-all duration-300 ease-in-out transform bg-white shadow-lg rounded-b-2xl z-20', isMobileMenuOpen ? 'translate-y-0 pointer-events-auto' : '-translate-y-full pointer-events-none')}>
          <div className="px-6 py-6 space-y-3">
            ...
            <a href="https://calendly.com/d/cnzm-3d9-xbj/esyntagi" target="_blank" rel="noopener noreferrer" className="block w-full py-2 text-center text-esyntagi-600 hover:text-esyntagi-700 font-medium">
